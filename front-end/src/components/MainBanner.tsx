  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex  items-center justify-center">
        <div
          className="relative w-[331px] h-[312px] 
          tablet:w-[704px] tablet:h-[508px]
        ...
        >
          ...
          <div className="absolute left-0 top-[44px] tablet:top-[140px] px-2">
            <h1
              className="font-semibold text-whitePrimary text-[42px] 
          ...
          <div
            className="absolute right-0 bottom-[104px] w-[200px] text-right
            tablet:bottom-[160px] tablet:right-[70px] tablet:w-[220px]  px-2"
          >
            <p
              className="font-400 text-whitePrimary text-[12px] leading-[16px] 
